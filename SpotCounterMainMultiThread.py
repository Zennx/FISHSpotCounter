...
def spot_count(input_dir, output_dir, progress_bar=None, progress_popup=None, root=None, update_every=5, batch_size=16):
    ...
    for i in range(0, total, batch_size):
        ...
        batch_results = process_images_batch(batch_files, output_dir)
