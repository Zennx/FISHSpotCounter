...
from core.image_processing import process_image, process_images_batch

save_overlay=True

def spot_count(input_dir, output_dir, progress_bar=None, progress_popup=None, root=None, update_every=15):
    ...
    with ThreadPoolExecutor() as executor:
        futures = {executor.submit(process_images_batch, f, output_dir): f for f in input_files}
        completed = 0
